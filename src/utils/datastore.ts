...
import { IncomeType } from '@/services/data-loader';

const PATH_PREFIX = path.join(SYSTEM_PATH, './src/assets/files/');
const LOGIN_DB_PATH = `${PATH_PREFIX}credential.db`;
const FINANCE_DB_PATH = `${PATH_PREFIX}data.db`;
...
class DataStore<T> extends NeDB {
